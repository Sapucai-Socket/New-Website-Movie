...
const Ficcao = () => {
    ...
    useEffect(() => {
        const topRatedUrl = `${moviesURL}popular?${apiKey}&with_genres=878&language=pt-BR&page=${currentPage}`;
                        ...
                        <Stack spacing={2} direction="row" justifyContent="center">
                            <Pagination
                                ...
                                renderItem={(item) => (
                                    <PaginationItem
                                        component={Link}
                                        to={`/ficcao?page=${item.page}`} // Ajuste a rota para '/ficcao?page='
                                        {...item}
                                        sx={{
                                            "&.Mui-selected": {
